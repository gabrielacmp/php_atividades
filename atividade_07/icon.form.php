        ...
        <section class="page-section" id="servicos">
            <div class="container">
                <div class="text-center mt-5">
                    <h2 class="section-heading">You're in icon register page.</h2>
                ...
                <form id="servicosForm" data-sb-form-api-token="API_TOKEN" method="POST" action="./register/icon.register.php">
