        ...
        <section class="page-section" id="servicos">
            <div class="container">
                ...
                <table class="table table-stripped" style="color: black;">
                    ...
                    <tbody>
                    <?php foreach(listShowcases() as $showcase): ?>
                        <tr>
                            <td><?= $showcase["id"] ?></td>
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('Deseja realmente remover este item?')" href="./delete/showcase.delete.php?id=<?= $showcase["id"] ?>"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
