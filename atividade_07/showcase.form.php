    ...
    <body>
        ...
        <section class="page-section" id="servicos">
            <div class="container">
                ...
                <h2 class="section-heading">You're in showcase register page.</h2>
                ...
                <form id="servicosForm" data-sb-form-api-token="API_TOKEN" method="POST" action="./register/showcase.register.php">
