...
<html lang="pt-br">
    <head>
        ...
        <title>Media's Table System</title>
        <!-- Favicon-->
                    ...
                    <?php foreach(listMedias() as $media): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('Deseja realmente remover este item?')" href="./delete/media.delete.php?id=<?= $media["id"] ?>"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
