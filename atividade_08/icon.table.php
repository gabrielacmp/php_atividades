        ...
        <section class="page-section" id="icons">
            <div class="container">
                ...
                <table class="table table-stripped" style="color: black;">
                    ...
                    <tbody>
                    <?php foreach($_SESSION['icon_list'] as $icon): ?>
                        <tr>
                            <td><?= $icon->id ?></td>
                            <td><?= $icon->image?></td>
                            <td><?= $icon->title ?></td>
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('Do you really want to remove this item?')" href="./delete/icon.delete.php?id=<?=$icon->id?>"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
