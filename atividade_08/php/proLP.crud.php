<?php
    ...
    #Retrieve
        function listIcons(){
            ...
            $listIcon = array();
            while($icon=mysqli_fetch_object($result)){
        ...
        function listShowcases(){
            ...
            $result = mysqli_query($link, $sql);
            $listShowcase = array();
            while($showcase=mysqli_fetch_object($result)){
        ...
        function listTestimonials(){
            ...
            while($testimonial=mysqli_fetch_object($result)){
        ...
        function listMedias(){
            ...
            $result = mysqli_query($link, $sql);
            $listMedia = array();
            while($media=mysqli_fetch_object($result)){
